  ...
  return (
    <div name="contact" className="w-full h-full bg-[#F8F8F8] text-[#13131a]">
      <motion.div
        ...
        className="text-3xl md:text-4xl font-playfair justify-center items-center text-center pt-8 mb-6"
      >
        <p className="pb-4">Let’s Build Great Teams Together.</p>
        <p className="text-2xl text-[#0d67c5] font-sans font-semibold">
      ...
      <motion.div
        ...
        className="w-full h-[100px] flex flex-row items-center bg-white/50 mt-6 px-4 py-6 gap-20 md:gap-[650px]"
      >
        <p className="text-sm md:text-xl font-semibold text-center pl-[45px] md:pl-40 mb-4 pt-6">
      ...
      >
        <div className="w-full h-auto bg-[#0d67c5] text-white p-8">
      ...
      <motion.div
        ...
        className="flex flex-row items-center bg-[#F8F8F8] p-8 gap-20 md:gap-[650px]"
      >
        <p className="text-sm md:text-[18px] text-center mb-4 pt-4 pl-[45px] md:pl-40">
          For online contact
        </p>
